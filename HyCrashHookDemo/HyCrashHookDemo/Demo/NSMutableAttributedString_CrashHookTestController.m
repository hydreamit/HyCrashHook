...
- (void)viewDidLoad {
    ...
    [HyCrashHookManager subscribeCrashWithClasses:@[NSAttributedString.class, NSMutableAttributedString.class] block:^(__unsafe_unretained Class cls, NSString *location, NSString *description, NSArray<NSString *> *callStack) {
