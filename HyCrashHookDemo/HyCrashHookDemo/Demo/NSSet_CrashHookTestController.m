//
//  NSSet_CrashHookTestController.m
//  HyCrashHook
...
#import "NSSet_CrashHookTestController.h"
#import "HyCrashHookManager.h"
#import "HyCrashHookMethods.h"


@implementation NSSet_CrashHookTestController
...
- (void)viewDidLoad {
    ...
    [HyCrashHookManager subscribeCrashWithClasses:@[NSSet.class] 
    ...
    id nilObject = nil;
    NSSet *set = [NSSet setWithObject:nilObject];
    NSLog(@"%@", set);
}
