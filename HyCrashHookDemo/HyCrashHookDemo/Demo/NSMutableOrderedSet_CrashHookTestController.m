...
- (void)viewDidLoad {
    ...
    [HyCrashHookManager subscribeCrashWithClasses:@[NSMutableOrderedSet.class] block:^(__unsafe_unretained Class cls, NSString *location, NSString *description, NSArray<NSString *> *callStack) {
